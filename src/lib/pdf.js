...
<div style="max-width:900px;margin:0 auto;padding:24px">
  <div style="background:#fff;border-radius:10px;padding:16px;border:1px solid #dde3ee;margin-bottom:14px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px">
      ...
      ${(report.avancePlaneado!==null&&report.avancePlaneado!==undefined)?`<div><div style="display:flex;justify-content:space-between;margin-bottom:4px;font-size:12px"><span>Avance Planeado</span><b style="color:#f5a623">${report.avancePlaneado}%</b></div><div style="background:#dde3ee;border-radius:6px;height:8px;overflow:hidden"><div style="width:${report.avancePlaneado}%;background:#f5a623;height:100%;border-radius:6px"></div></div></div>`:""}
    </div>
